...
const technologiesLinks = [
  ...
  },
  {
    ...
    slug: "electronic-data-capture",
  },
  {
    name: "eTMF Technology",
    slug: "etmf-technology",
  },
  {
    name: "Interactive Response Technology",
    slug: "interactive-response-technology",
  },
];
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-[100] bg-[#08052b] shadow-lg bg-blur">
      <div className="max-w-7xl mx-auto px-6 py-2 flex items-center justify-between">
        ...
        {/* DESKTOP MENU */}
        <nav className="hidden lg:flex items-center gap-10  px-10 py-3 rounded-full text-white text-sm shadow-lg font-semibold ml-20 pl-10 mt-4">

          {/* <Link href="/" className="hover:text-orange-400 transition">Home</Link> */}
          <Link href="/" className="text-[18px] font-semibold text-white hover:text-gray-500">Home</Link>

          <Link href="https://eric-solutions-ai.vercel.app/" target="_blank" className="text-[18px] font-semibold text-white hover:text-gray-500 whitespace-nowrap">Eric AI</Link>
